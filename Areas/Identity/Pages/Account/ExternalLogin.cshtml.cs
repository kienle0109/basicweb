...
namespace Razorweb.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                //Claim-Dac tinh mo ta cua 1 doi tuong
                if (info.Principal.HasClaim(c => c.Type == ClaimTypes.Email))
                {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Khong ho tro tao tai khoan moi-Co email khac email tu dich vu ngoai");
                    return Page();
                }
                if ((externalEmailUser == null) && (externalEmail == Input.Email))
                {
                    var newUser = new AppUser { UserName = Input.Email, Email = Input.Email };
